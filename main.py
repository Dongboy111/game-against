...
for k in range(1):
    ...
    while True:
        ...
        action1 = dqnAgent1.act(state)#格式应该为[]     [UP,DOWN]
        ...
        if done:
            # pyplot.plot(dqnAgent1.lossM,[x for x in range(0,len(dqnAgent1.lossM))])
            # pyplot.show()
            print(dqnAgent1.lossM)
        ...
        dqnAgent1.train_exp(5)
        dqnAgent2.train_exp(5)
